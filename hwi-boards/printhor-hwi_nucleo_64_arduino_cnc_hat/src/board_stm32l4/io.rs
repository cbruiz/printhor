...
pub mod usbserial {
    ...
    impl USBSerialDevice {
        pub fn new(driver: USBDrv) -> Self {
            ...
            #[link_section = ".bss"]
            static CONFIG_DESCRIPTOR_ST: crate::board_stm32l4::TrackedStaticCell<[u8; 256]> =
                crate::board_stm32l4::TrackedStaticCell::new();
            let config_descriptor =
                CONFIG_DESCRIPTOR_ST.init::<{ crate::board::MAX_STATIC_MEMORY }>("", [0; 256]);
            #[link_section = ".bss"]
            static BOS_DESCRIPTOR_ST: crate::board_stm32l4::TrackedStaticCell<[u8; 256]> =
                crate::board_stm32l4::TrackedStaticCell::new();
            let bos_descriptor =
                BOS_DESCRIPTOR_ST.init::<{ crate::board::MAX_STATIC_MEMORY }>("", [0; 256]);
            #[link_section = ".bss"]
            static CONTROL_BUF_ST: crate::board_stm32l4::TrackedStaticCell<[u8; 64]> =
                crate::board_stm32l4::TrackedStaticCell::new();
            let control_buf =
                CONTROL_BUF_ST.init::<{ crate::board::MAX_STATIC_MEMORY }>("", [0; 64]);

            #[link_section = ".bss"]
            static STATE_ST: crate::board_stm32l4::TrackedStaticCell<
                embassy_usb::class::cdc_acm::State,
            > = crate::board_stm32l4::TrackedStaticCell::new();
            let state = STATE_ST.init::<{ crate::board::MAX_STATIC_MEMORY }>(
                "",
        ...
        pub fn spawn(&mut self, spawner: crate::board_stm32l4::Spawner) {
            self.builder
                .take()
    ...
    pub struct USBSerialDeviceInputStream {
        receiver:
            embassy_usb::class::cdc_acm::Receiver<'static, crate::board_stm32l4::device::USBDrv>,
